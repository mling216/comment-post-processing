...
Usage:
    python _vc_score_api.py                        # process all images from mapping CSV
    python _vc_score_api.py --limit 5              # process first N images
    python _vc_score_api.py --overwrite            # re-process already scored images
    python _vc_score_api.py --source local         # use local image files
    python _vc_score_api.py --source url            # fetch images from URLs (default)
    python _vc_score_api.py --outdir results       # custom output directory
"""

...
Usage:
    python _vc_score_api_v0_topic.py --input-csv ../Claude_vc_prediction/gt_all_46.csv --outdir ../vc_api_46gt_v0_topic
    python _vc_score_api_v0_topic.py --input-csv ../Claude_vc_prediction/gt_all_46.csv --outdir ../vc_api_46gt_v0_topic --concurrency 5
"""
...
DEFAULT_OUTDIR = Path(__file__).parent.parent / 'vc_api_46gt_v0_topic'

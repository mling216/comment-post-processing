...
python _vc_score_api_v0.py --input-csv %INPUT% --outdir ..\vc_api_46gt_v0_r4 --concurrency %CONCURRENCY% --thinking
if errorlevel 1 ( echo ERROR on V0 & exit /b 1 )
echo.

echo [2/2] V0+TCA (r4, thinking)
python _vc_score_api_v0_topic_calib_anchor.py --input-csv %INPUT% --outdir ..\vc_api_46gt_v0_tca_r4 --concurrency %CONCURRENCY% --thinking

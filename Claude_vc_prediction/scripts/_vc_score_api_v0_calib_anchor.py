"""
Claude API Visual Complexity (VC) Scoring — V0+Calibration+Anchors
===================================================================
V0 baseline + calibration guidance + 3 anchor images. No topic descriptions.

Usage:
    python _vc_score_api_v0_calib_anchor.py --input-csv ../Claude_vc_prediction/gt_all_46.csv --outdir ../results/vc_api_46gt_v0_ca --concurrency 5
"""
...
DEFAULT_OUTDIR = Path(__file__).parent.parent / 'results' / 'vc_api_46gt_v0_ca'
...
# ── System Prompt — V0 + Calibration + Anchors (no topics) ────────────────
...
def main():
    parser = argparse.ArgumentParser(description='V0+Calibration+Anchors VC Scoring via Claude API')
    ...
    print(f'=== V0+Calibration+Anchors (calibration + anchors, no topics) ===')
    print(f'Model:          {MODEL}')

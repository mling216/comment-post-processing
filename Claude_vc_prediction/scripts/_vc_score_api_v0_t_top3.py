"""
Claude API Visual Complexity (VC) Scoring — V0+Topic (Top-3 variant)
=====================================================================
V0+Topic prompt extended with a top-3 topic-selection task. Model is asked
...
Usage:
    python _vc_score_api_v0_t_top3.py --input-csv ../Claude_vc_prediction/gt_all_46.csv --outdir ../results/vc_api_topicsel_v0_t --concurrency 5 --model claude-opus-4-6
"""
...
DEFAULT_OUTDIR = Path(__file__).parent.parent / 'results' / 'vc_api_topicsel_v0_t'
...
def main():
    ...
    print(f'=== V0+Topic + Top-3 (definition + 7 topics + top-3 topic selection) ===')
    print(f'Model:          {MODEL}')
